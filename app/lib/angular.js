/**
 * @license AngularJS v1.2.2-84c408c
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-84c408c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-84c408c',    // all of these placeholder strings will be replaced by grunt's
